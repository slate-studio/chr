...
email client etc. It's responsive by default and designed to be data source independent.
  ...
  s.extra_rdoc_files = %w[README.md LICENSE.md CONTRIBUTING.md]
  s.license          = "MIT"
  ...
  s.add_dependency "formagic", ">= 0.3.10"
  ...
  s.add_development_dependency "responders", "2.1.0" # Problems with Tests (don't work with database cleaner)
